...
class Populator
{
     ...
     *
     * @param mixed $entity A Propel ActiveRecord classname, or a \Biberltd\Faker\ORM\Propel2\EntityPopulator instance
     * @param int   $number The number of entities to populate
     */
    public function addEntity($entity, $number, $customColumnFormatters = array(), $customModifiers = array())
    {
        if (!$entity instanceof \Biberltd\Faker\ORM\Propel2\EntityPopulator) {
            $entity = new \Biberltd\Faker\ORM\Propel2\EntityPopulator($entity);
        }
